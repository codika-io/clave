// Brand marks for the supported CLI tools. Shared so the New Session menu and the
 ...
 */
export function ClaudeVariantGlyph({ variant }: { variant: ClaudeVariant }): React.JSX.Element {
  const Glyph = variant === 'agents' ? UserGroupIcon : ForwardIcon
  return (
    <span
      className="flex-shrink-0 text-text-tertiary"
      title={variant === 'agents' ? 'Claude Agents' : 'Skip permissions'}
    >
...
export function ClaudeLogo({ className }: { className?: string }): React.JSX.Element {
  return (
...
export function CodexLogo({ className }: { className?: string }): React.JSX.Element {
  return (
    <svg className={className} width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
...
/** Official Pi mark, adapted to currentColor for Clave's four themes.
 * Source and license: https://pi.dev/press-kit */
export function PiLogo({ className }: { className?: string }): React.JSX.Element {
  return (
    <svg className={className} width="14" height="14" viewBox="0 0 800 800" xmlns="http://www.w3.org/2000/svg">
      <path
        fill="currentColor"
        fillRule="evenodd"
