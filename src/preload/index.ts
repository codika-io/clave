...
const electronAPI = {
  spawnSession: (cwd: string, options?: { dangerousMode?: boolean; claudeMode?: boolean; geminiMode?: boolean; codexMode?: boolean; resumeSessionId?: string; initialCommand?: string; autoExecute?: boolean }) =>
